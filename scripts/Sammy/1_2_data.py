...
TRAIN_FILE = DATA_DIR / 'train_parquet'
LAGS_FEATURES_TRAINING = DATA_DIR / 'lags_features'/'training.parquet'
LAGS_FEATURES_VALIDATION = DATA_DIR / 'lags_features'/'validation.parquet'
