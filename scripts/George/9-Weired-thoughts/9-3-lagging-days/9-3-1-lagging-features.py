...
if is_linux:
	...
	original_data = "E:\Python_Projects\Optiver\JaneStreetMktPred\data\jane-street-real-time-market-data-forecasting\\train.parquet"
...
X_train = load_data(original_data, start_dt=1450, end_dt=1500)
...
#
# X_valid = load_data(original_data, start_dt=1650, end_dt=1690)
