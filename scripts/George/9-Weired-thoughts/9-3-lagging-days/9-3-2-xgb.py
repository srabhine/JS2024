...
with open('/home/zt/pyProjects/JaneSt/Team/scripts/George/9-Weired-thoughts/9-3-lagging-days/models/xgb_model_1.pkl', 'wb') as file:
    pickle.dump(model, file)

model.save_model(
    '/home/zt/pyProjects/JaneSt/Team/scripts/George/9-Weired-thoughts/9-3-lagging-days/models/xgb_model_self_1.json')
